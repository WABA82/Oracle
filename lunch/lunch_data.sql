...
values(lunch_code,'포크칠리','m1_l1.gif',4500,'포크칠리-돈까스와 떡갈비에 탕수육까지 환상의 조합으로
 다양한 맛을 느끼실 수 있는 부분 인지용.','admin');
insert into lunch(LUNCH_CODE, LUNCH_NAME, IMG, PRICE, SPEC, ID)
values(lunch_code,'돈까스','m1_l2.gif',3800,'돈까스-누구나 좋아하는 돈까스!
...
insert into ordering(ORDER_NUM, QUAN, ORDER_NAME, PHONE, IP_ADDRESS, LUNCH_CODE)
values(order_code,1,'이재현','010-2314-8781','211.63.89.135','L_000002');
commit;
